...
def implement_set_api_key(api_key):
    """
    IMPLEMENTED: Set the GROQ_API_KEY environment variable.
...
def implement_llama_4_model():
    """
    IMPLEMENTED: Create and return a ChatGroq instance for Llama 4.
...
def implement_llama_3_3_model():
    """
    IMPLEMENTED: Create and return a ChatGroq instance for Llama 3.3.
    Use the exact model name from console.groq.com
...
def implement_query_model(model, prompt):
    """
    IMPLEMENTED: Send a query to the model and return the response content.
...
def implement_compare_models(prompt):
    """
    IMPLEMENTED: Query both models and return a dictionary with both responses.
